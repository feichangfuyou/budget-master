...
export function Sidebar({ activeView, onViewChange }: SidebarProps) {
  ...
  const navItems = [
    ...
    { id: 'transactions', label: 'Transactions', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
    { id: 'forecasts', label: 'Forecasts', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-4 top-4 z-50 flex size-10 items-center justify-center rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 lg:hidden"
      ...
      >
        <div className="flex h-full flex-col">
          <div className="flex h-16 items-center gap-3 border-b border-gray-200 px-4">
            ...
            <div>
              <h2 className="text-balance text-sm font-semibold text-gray-900">Budget Master</h2>
          ...
          <div className="border-t border-gray-200 p-4">
            <div className="rounded-lg bg-blue-50 p-3">
              <p className="text-balance text-xs font-medium text-blue-900">Need help?</p>
              <p className="mt-1 text-pretty text-xs text-blue-700">
                Use the chat below to ask questions about your budget.
              </p>
            </div>
          </div>
        </div>
